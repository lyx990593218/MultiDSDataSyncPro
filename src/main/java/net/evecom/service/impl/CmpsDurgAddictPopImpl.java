...
public class CmpsDurgAddictPopImpl extends BaseServiceImpl implements IDataSync{
     ...
     *  省网数据表名
     */
    private static String TABLENAME = "PINGTAN.S_PTZH_POP_DURG_ADDICT";
    ...
    public String getFindSql() {
        return "select * from S_PTZH_POP_DURG_ADDICT_V WHERE 1=1 AND (TO_CHAR(ADD_TIME, 'YYYY-MM-DD') = TO_CHAR(SYSDATE - 1, 'YYYY-MM-DD') OR TO_CHAR(UPDATE_TIME, 'YYYY-MM-DD') = TO_CHAR(SYSDATE - 1, 'YYYY-MM-DD'))";
