 ...
 */
@Service
public class DeleteCmpsDurgAddictPopImpl extends DeleteBaseServiceImpl implements IDataSync{

    /**
     * The constant LOG.
     */
    private static final Logger LOG = LoggerFactory.getLogger(DeleteCmpsDurgAddictPopImpl.class);
...
//        return "select * from S_PTZH_POP_DURG_ADDICT_V WHERE 1=1";
    ...
    public String getFindTargetSql() {
        return "select * from S_PTZH_POP_DURG_ADDICT_V WHERE 1=1 AND IDENTITY_NUM = ?";
