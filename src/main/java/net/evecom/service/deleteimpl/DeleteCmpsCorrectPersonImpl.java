 ...
 */
@Service
public class DeleteCmpsCorrectPersonImpl extends DeleteBaseServiceImpl implements IDataSync {

    /**
     * The constant LOG.
     */
    private static final Logger LOG = LoggerFactory.getLogger(DeleteCmpsCorrectPersonImpl.class);
...
//        return "select * from S_PTZH_POP_CORRECT_PERSON_V WHERE 1=1";
    ...
    public String getFindTargetSql() {
        return "select * from S_PTZH_POP_CORRECT_PERSON_V WHERE 1=1 AND IDENTITY_NUM = ?";
