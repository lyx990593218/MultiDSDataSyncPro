 ...
 */
@Service
public class DeleteCmpsMentalPatientImpl extends DeleteBaseServiceImpl implements IDataSync {
     ...
     *  省网数据表名
     */
    private static final String TABLENAME = "S_PTZH_POP_MENTAL_PATIENT";
...
//        return "select * from S_PTZH_POP_MENTAL_PATIENT_V WHERE 1=1";
    }
    @Override
    ...
    public String getFindTargetSql() {
        return "SELECT * from S_PTZH_POP_MENTAL_PATIENT_V WHERE 1=1 AND IDENTITY_NUM = ? ";
    }
