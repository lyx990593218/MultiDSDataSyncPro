 ...
 */
@Service
public class DeleteCmpsComManageCenterImpl extends DeleteBaseServiceImpl implements IDataSync{

    /**
     * The constant LOG.
     */
    private static final Logger LOG = LoggerFactory.getLogger(DeleteCmpsComManageCenterImpl.class);
    ...
    public String getFindSql() {
        return StringUtils.format(findSqlTpl, getOurPkFieldName(), "S_PTZH_GRID_COM_MANAGE_CENTER");
...
//        return "select * from S_PTZH_GCMC_V WHERE 1=1";
    ...
    public String getFindTargetSql() {
        return "select * from S_PTZH_GCMC_V WHERE 1=1 AND CENTER_NAME = ?";
